...
interface Top10CountriesWheelProps {
  translations: any;
  lang: string;
}
...
export default function Top10CountriesWheelClient({ translations, lang }: Top10CountriesWheelProps) {
  ...
  return (
    <>
      <WheelPageClient
        lang={lang}
        translations={t}
        storageKeySuffix="top-10-countries"
