...
interface YesNoMaybeWheelProps {
  translations: any;
  lang: string;
}

const segmentColors = ["#2f855a", "#c53030", "#d69e2e"]; 

export default function YesNoMaybeWheelClient({ translations, lang }: YesNoMaybeWheelProps) {
  ...
  return (
    <>
      <WheelPageClient
        lang={lang}
        translations={t}
        storageKeySuffix="yes-no-maybe"
        initialOptions={t.defaultOptions}
        pageTitle={t.pageTitle}
        pageDescription={t.description}
        showOptionsPanel={false}
        wheelColors={segmentColors}
        textColor="#FFFFFF"
