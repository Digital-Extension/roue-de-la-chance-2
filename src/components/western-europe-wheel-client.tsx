...
interface WesternEuropeWheelProps {
  translations: any;
  lang: string;
}
...
const countryColors = [
  ...
  "#f95d6a", "#ff7c43", "#ffa600", "#488f31", "#84b55b", "#cce088"
];

export default function WesternEuropeWheelClient({ translations, lang }: WesternEuropeWheelProps) {
  ...
  return (
    <>
      <WheelPageClient
        lang={lang}
        translations={t}
        storageKeySuffix="western-europe"
        initialOptions={t.defaultOptions}
        pageTitle={t.pageTitle}
        pageDescription={t.description}
        showOptionsPanel={true}
        wheelColors={countryColors}
        textColor="#FFFFFF"
      ...
      <section className="w-full max-w-5xl mx-auto p-4 lg:p-8">
        <div className="bg-card text-card-foreground rounded-lg border shadow-lg p-8 space-y-8">
            ...
            <div className="space-y-4">
                ...
                <p className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{__html: t.whatIsText.replace('/fr', `/${lang}`)}}/>
            </div>
